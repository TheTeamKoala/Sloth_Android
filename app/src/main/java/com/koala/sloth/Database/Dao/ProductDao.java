...
public class ProductDao {
   ...
   public void implementExampleDatabase() {    // ORNEK BIR DATABASE OLUSTURMAK ICIN CAGRILIYOR.
        ...
        addOrderProduct("Apple", null,"Fruit", 2.00, "TL", "kg", 1551615240120L, true, getDrawableAsByteArray(R.drawable.apple));
        ...
        addOrderProduct("Tomato",null, "Vegetable", 2.00, "TL", "kg", 1551615240120L, true, getDrawableAsByteArray(R.drawable.tomato));
        addOrderProduct("Cucumber", null,"Vegetable", 2.25, "TL", "kg", 1551615240120L, true, getDrawableAsByteArray(R.drawable.cucumber));
        addOrderProduct("Potato", null,"Vegetable", 2.50, "TL", "kg", 1551615240120L, false, getDrawableAsByteArray(R.drawable.potato));
        addOrderProduct("Carrot", null,"Vegetable", 2.75, "TL", "kg", 1551615240120L, true, getDrawableAsByteArray(R.drawable.carrot));
        ...
        addOrderProduct("Salami", "Namet","Meat", 11.00, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.namet_salami));
        addOrderProduct("Sausage", "Namet","Meat", 11.25, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.namet_sausage));

        addOrderProduct("Pepsi Cola", "Pepsi","Drink", 3.00, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.pepsi_cola));
        addOrderProduct("Fanta", null,"Drink", 3.25, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.fanta));
        ...
        addOrderProduct("Juice","SEK", "Drink", 4.00, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.sek_juice));
        addOrderProduct("Juice","Cappy", "Drink", 4.25, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.cappy_juice));
        ...
        addOrderProduct("Canga", "Eti","Junk Food", 5.75, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.canga));
        addOrderProduct("Toblerone", null,"Junk Food", 6.00, "TL", "piece", 1551615240120L, false, getDrawableAsByteArray(R.drawable.toblerone));
        addOrderProduct("Toffie",null, "Junk Food", 6.25, "TL", "piece", 1551615240120L, true, getDrawableAsByteArray(R.drawable.toffie));
